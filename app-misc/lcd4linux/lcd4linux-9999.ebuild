...
WANT_AUTOMAKE="1.9"
inherit eutils multilib autotools subversion libtool
...
ESVN_REPO_URI="https://ssl.bulix.org/svn/lcd4linux/trunk"
ESVN_PROJECT="lcd4linux"
...
IUSE_LCD_DEVICES=(beckmannegle bwct cfontz ncurses cwlinux
		...
		mtxorb milfordbpk noritake null picolcd picolcdgraphic
...
src_unpack() {
	...
	#epatch "${FILESDIR}/${PN}-0.10.1_rc2-warnings.patch"
	#epatch "${FILESDIR}/${PN}-0.10.1_rc2-mpd.patch"
	#epatch "${FILESDIR}/${PN}-0.10.1_rc2-nordtsc.patch"
	#epatch "${FILESDIR}/${PN}-0.10.1_rc2-autoconf-2.65.patch"
...
src_compile() {
	...
	local DEVICE_DRIVERS=(BeckmannEgle BWCT CrystalFontz Curses Cwlinux
		...
		LCDLinux LCDTerm LEDMatrix LPH7508 M50530
		MatrixOrbital MilfordInstruments Noritake NULL picoLCD picoLCDGraphic
		PNG PPM RouterBoard serdisplib SimpleLCD
